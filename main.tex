...
A fabulously challenging machine, the effort to describe SuperKEKB has led to not only developments of the Xsuite code, but further developments of the collaborative links between CERN and our colleagues at KEK.
...
On the technical front, SuperKEKB represents a key challenge due to the overlap of its experimental solenoid (used by the detectors to enable the identification of particles) and the final focus quadrupoles (used to squeeze the beams down to heights on the nano-metre scale)!
