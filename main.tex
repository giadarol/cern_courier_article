...
{\large G. Broggi, S. Lopaciuk, J. Salvesen}\\
...
\begin{itemize}
    \item \href{http://xsuite.web.cern.ch/}{http://xsuite.web.cern.ch/}
    \item G. Iadarola, R. De Maria, et al. “Xsuite: An Integrated Beam Physics Simulation Framework,” JACoW HB2023 (2024), TUA2I1.
    \item F. Van der Veken et al. “Recent Developments with the New Tools for Collimation Simulations in Xsuite,” JACoW HB2023 (2024), THBP13.
\end{itemize}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.7\linewidth]{xsuite_logo_alpha.eps}
    \caption{Xsuite logo.}
...
\begin{figure}[tb]
    ...
    \caption{Xsuite-generated display of the beam pipes and beam envelopes at $3\sigma$ (6.8 TeV, $\beta^* = 30 \textrm{ cm}$) around ATLAS, ALICE, CMS, and LHCb (left to right, top to bottom). Longitudinal-to-transverse scale: 3 m : 1 cm.}
\end{figure}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.9\linewidth]{superkekb_ip.png}
    \caption{SuperKEKB interaction region showing the Belle II solenoid (orange), compensation solenoids (green), and the magnetic elements of the two beam rings (blue and red).}
    \label{fig:superkekb_ip}
\end{figure}
