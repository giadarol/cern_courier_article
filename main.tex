...
On the modeling front, SuperKEKB represents a key challenge due to the overlap of its experimental solenoid (used by the detectors to enable the characterization of particles produced by the collision) and the final focus quadrupoles (used to squeeze the beams down to heights on the nano-metre scale)!
